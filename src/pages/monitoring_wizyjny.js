...
const MonitoringContent = (
  <p>
    <h4>W ZAKRESIE USŁUG MONITORINGU</h4>
    <br />
    <b>Proponujemy:</b>
    <ul>
    ...
    <ul>
      ...
      <li>
        – indywidualny dobór rozwiązań technicznych w zależności od typu obiektu
      </li>
      <li>– wysoką jakość</li>
    </ul>
    <br />
    <h4>W RAMACH OCHRONY MOBILNEJ</h4>
    <br />
    <b>Proponujemy:</b>
    <ul>
